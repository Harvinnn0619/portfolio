          ...
          {projects.map((p, i) => (
            <div
              ...
              onMouseEnter={e => {
                ...
                el.style.borderColor = "rgba(87,199,133,0.4)";
                el.style.transform = "translateY(-6px)";
                el.style.boxShadow = "0 20px 60px rgba(59,8,64,0.3), 0 0 0 1px rgba(87,199,133,0.1)";
              }}
              onMouseLeave={e => {
                const el = e.currentTarget as HTMLElement;
            ...
            >
              <p style={{ fontFamily: "monospace", fontSize: "0.65rem", color: "#716FA8", letterSpacing: "0.1em", marginBottom: "1.5rem" }}>{p.num}</p>
              <h3 style={{ fontSize: "1.3rem", fontWeight: 700, letterSpacing: "-0.02em", marginBottom: "0.75rem", color: "#ffffff" }}>{p.title}</h3>
              <p style={{ fontFamily: "monospace", fontSize: "0.8rem", color: "#a8a6c8", lineHeight: 1.7, marginBottom: "1.5rem" }}>{p.desc}</p>
              <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem", marginBottom: "1.5rem" }}>
                {p.tags.map(tag => (
                  <span key={tag} style={{
                    ...
                    border: "1px solid rgba(87,199,133,0.2)",
                    color: "#57C785", borderRadius: "4px",
                  }}>{tag}</span>
                ))}
              </div>
              <a href={p.link} style={{ fontFamily: "monospace", fontSize: "0.7rem", letterSpacing: "0.08em", color: "#57C785", textDecoration: "none", textTransform: "uppercase" }}>
                View Project →
              </a>
            </div>
          ))}
